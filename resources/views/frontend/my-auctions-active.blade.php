            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-8">
                    <div class="dash-bid-item dashboard-widget mb-40-60">
                        <div class="header">
                            <h4 class="title">Active Auctions List ( <a style="color: #ee4730;text-decoration: underline;" href="{{ route('frontend.newAuction') }}" > New Auction </a> ) </h4>
                        </div>
                                        ...
                                        <tbody>
                                            @foreach($auctions as $auction)
                                                <tr>
                                                    ...
                                                    <td data-purchase="expires"><a href="{{ route('my-auction-products', ['slug' => $auction->slug]) }}"> View Details</a></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
