            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-8">
                    <div class="dash-bid-item dashboard-widget mb-40-60">
                        <div class="header">
                            <div class="row">
                                <h4 class="title">{{ __('Auction Product Winner Summary') }}</h4>
                                <h6 style="margin-top: 10px;" class="title">{{ __('Winner Contact Details') }}: <small> {{ $product->winner->phone }} </small> </h6>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        <tbody>
                                            @foreach($product->bids as $bid)
                                                @if ($product->winner_id && $bid->winner_status == 1)
