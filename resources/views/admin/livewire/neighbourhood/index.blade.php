<div class="col-12">
    ...
    <h2 class="page-title">{{ __('Neighbourhood List') }}</h2>
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <select wire:model.defer="country_id" wire:change="p_categoryChanged($event.target.value)" class="form-control form-control-sm">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <select wire:model="city_id" class="form-control form-control-sm">
